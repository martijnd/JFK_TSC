...
function introPage() {
    ...
    $("#artH2").css("font-family", "Special Elite").css("color", "white").html(
        "Press the seal to confirm you are at least 18 years of age.").fadeIn();
    $("#enterPage").hover(function() {
        ...
        if (clicked == false) {
            $("#artH2").empty().html(
                "Press the seal to confirm you are 18 years of age."
            );
        } else {
            $("#artH2").empty().html(
                "Entering 'The Sworn Commitment'");
        }
    });
    $("#enterPage").click(function() {
        ...
        $("#introBanner").fadeOut(1000).queue(function() {
            $("#artH1").css("transition", "opacity 2s").css(
                "opacity", "0").queue(function() {
                $("#artH2").css("transition",
                    "margin-top 2s").css(
                    "margin-top", "10%");
                $("#aside").fadeOut(500);
            });
...
function introPageExit() {
        ...
        $("#article").fadeOut(1000).queue(function() {
            $("#article").css("height", "0px").css("background-color",
                "none");
            $("#artText").hide();
            fill();
            hallway();
...
function hallway() {
        ...
        $("#gangH2").html("Welcome to JFK - The Sworn Commitment.").delay(1500)
            .fadeOut(500).queue(function() {
                $("#gangUitleg").hide();
                $("#gangH2").delay(500).html(
                    "To start off, click anywhere.").show();
                $("#gangUitleg").fadeIn(500);
            });
        $("#closeIt").click(function() {
            closeIt = closeIt + 1;
            if (closeIt == 1) {
                $("#gangH2").fadeOut(500).html(
                    "Great. You are able to dismiss every pop-up like this."
                ).fadeIn(500);
            }
            if (closeIt == 2) {
                $("#gangH2").fadeOut(500).html(
                    "Your name is Ainsley Prescott, a private investigator. "
                ).fadeIn(500);
                //fadeIn foto
            }
            if (closeIt == 3) {
                $("#gangH2").fadeOut(500).html(
                    "You are hired by someone called Abraham Zapruder."
                ).fadeIn(500);
                //fadeIn foto
            }
            if (closeIt == 4) {
                $("#gangH2").fadeOut(500).html(
                    "Zapruder has provided you with the footage he shot of the assassination of Kennedy."
                ).fadeIn(500);
            }
            if (closeIt == 5) {
                $("#gangH2").fadeOut(500).html(
                    "He wants transparency on what happened that day."
                ).fadeIn(500);
            }
            if (closeIt == 6) {
                $("#gangH2").fadeOut(500).html(
                    "You have been working on a report but it isn't done yet. You are missing some last bits of information."
                ).fadeIn(500);
            }
            if (closeIt == 7) {
                $("#gangH2").fadeOut(500).html(
                    "In your room is a setup that you can use to further your investigation. Click on the arrow to walk to your apartment."
                ).fadeIn(500);
            }
            //code voor laatste klik
            if (closeIt == 8) {
                $("#gangH2").fadeOut(500).html("Good luck, detective.")
                    .fadeIn(500);
                $("#next").fadeIn(1000);
...
function explain() {
        $("#fadeTo").append("<div id='temp'></div>").css("background-color",
            "none !important");
        $("#temp").html(
            "<h2 id='tempH2'>You enter your room and get welcomed by your dog.</div>"
        ).fadeIn().delay(3000).fadeOut().queue(function() {
            livingroom();
            $("#dop").hide();
            $("#tvPage").show();
            $("#fadeTo").fadeOut(1000);
...
function livingroom() {
        ...
        $("#tvTimeVid").append(
            '<source src="Video/videoZap.mp4" type="video/mp4"></source>');
        $("#radioTimeAud").append(
            '<source src="Audio/radioPres.mp3" type="audio/mp3"></source>');
        $("#dogeTimeAud").append(
            '<source src="Audio/wow.mp3" type="audio/mp3"></source>');
        //tijd voor een beetje uitleg
        $("#tvUitleg").fadeIn(2000);
        $("#tvH2").html(
            "You can now explore this room to investigate the case.").delay(
            2500).fadeOut(500).queue(function() {
            $("#tvUitleg").hide();
            $("#closeIt").css("z-index", "3");
            $("#closeIt").click(function() {
            ...
            $("#tvH2").delay(500).html(
                "You can progress through the map, watch tv or listen to the radio. The calendar leads to the next stage."
            ).show();
            $("#tvUitleg").fadeIn(500);
        });
        $("#closeIt").click(function() {
        ...
        $("#bvOverlay").hover(function() {
            $("#tvUitleg").fadeIn(500);
            $("#tvH2").html(
                "Find the date of the funeral to progress to the next stage."
            );
...
function map() {
    ...
    $("#button1").click(function() {
        ...
        //													CONTENT BUTTON 1
        $("#video").html("<span><h2>The motorcade</h2></span>").css(
            "margin-bottom", "5%").css("margin-top", "2%");
        $("#text").html(
            "<span><p>John F. Kennedy arrived in Dallas at the airfield on 11:38 AM. <br>From there he got into the presidential limousine. He was accompanied by Mrs. Kennedy, Texas Governor Connally and Mrs. Connally. The motorcade had to cover ten miles of crowded streets. Almost 150.000 people came to watch the president drive by that day. <br><br>On the right you can see the route the motorcade took. At 12:21 PM, the motorcade turned onto Main Street. Paired with loud cheering, the motorcade turned left onto Elm Street at 12:29.</p></span>"
        ).css("text-align", "left").css("display", "block").css(
            "color", "black").css("float", "left").css("width",
            "25%").css("margin-left", "10%");
        $("#image").html(
            "<video id='kaartVideo1' class='video'><source src='Video/video6.mp4' type='video/mp4'></source></video>"
        ).css("width", "25%").css("margin-left", "auto").css(
            "margin-right", "auto");
    ...
    $("#button2").click(function() {
        ...
        $("#text").html(
            "<span><p>At approximately 12:29, the first shot was fired. However, It didn't hit the president or the other passengers of the presidential limousine. The bullet was never found but almost all of the testimonials from the bystanders confirmed the sound of three shots, not two.</p></span>"
        );
        $("#image").html(
            "<video id='kaartVideo1' class='video'><source src='Video/GunShot1.mp4' type='video/mp4'></source>"
        ).css("width", "25%").css("margin-left", "auto").css(
            "margin-right", "auto");
        var vid = document.getElementById("kaartVideo1");
        vid.play();
    ...
    $("#button3").click(function() {
        ...
        //													CONTENT BUTTON 3
        $("#text").html(
            "<span><p>At 12:30 the second shot hit John F. Kennedy and governor Connally. There are a lot of assumptions about this shot, the main one being the so called “magic bullet”. This theory claims that the second bullet went through the neck of John F. Kennedy. This checks out, in the footage you can clearly see John F. Kennedy grabbing his neck.</p></span>"
        ).css("text-align", "left").css("display", "block").css(
            "color", "black").css("float", "left").css("width",
            "25%");
        $("#image").html(
            "<video id='kaartVideo1' class='video'><source src='Video/GunShot2.mp4' type='video/mp4'></source></video>"
        ).css("width", "25%").css("margin-left", "auto").css(
            "margin-right", "auto");
        var vid = document.getElementById("kaartVideo1");
        vid.play();
    ...
    $("#button4").click(function() {
        ...
        //CONTENT 
        $("#video").html("<span><h2>The Third Shot</h2></span>").css(
            "margin-bottom", "5%").css("margin-top", "2%").css(
            "color", "red");
        $("#text").html(
            "<span><p>At 12:30 the third shot hit John F. Kennedy. Only seconds later than the second shot. This was the fatal shot. This shot chipped the side of his head and inflicted fatal damage to his brain. There are conspiracies about this shot as well. Some people claim he was in the Texas school book depository, other people claim to have heard a shot come from the grassy knoll, the group of trees next to the white pagoda.</p></span>"
        ).css("text-align", "left").css("display", "block").css(
            "color", "black").css("float", "left").css("width",
            "25%").css("margin-left", "10%");
        $("#image").html(
            "<video id='kaartVideo1' class='video'><source src='Video/GunShot3.mp4' type='video/mp4'></source></source></video>"
        ).css("width", "25%").css("margin-left", "auto").css(
            "margin-right", "auto");
        var vid = document.getElementById("kaartVideo1");
        vid.play();
    ...
    $("#button5").click(function() {
        ...
        //CONTENT 
        $("#video").html(
            "<span><h2>Oswald's Vantage Point</h2></span>").css(
            "margin-bottom", "5%").css("margin-top", "2%");
        $("#text").html(
            "<span><p>From this room in the Texas School Book depository, Lee Harvey Oswald had this view</p></span>"
        ).css("text-align", "left").css("display", "block").css(
            "color", "black").css("float", "left").css("width",
            "25%").css("margin-left", "10%");
        $("#image").prepend(
            '<img id="oswald" src="imgs/oswald-view.jpg" />').css({
            "width": "25%",
            "margin-left": "auto",
            "margin-right": "auto",
            "top": "20%"
    ...
    $('#button1').on('mouseenter', function() {
        $("div.description").html("THE MOTORCADE").css({
            "top": "14%",
            "left": "44%"
        }).show();
    ...
    $('#button2').on('mouseenter', function() {
        $("div.description").html("THE FIRST SHOT").css({
            "top": "46%",
            "left": "26%"
        }).show();
    }).on('mouseleave', function() {
    ...
    $('#button3').on('mouseenter', function() {
        $("div.description").html("THE SECOND SHOT").css({
            "top": "55%",
            "left": "39%"
        }).show();
    }).on('mouseleave', function() {
    ...
    $('#button4').on('mouseenter', function() {
        $("div.description").html("THE THIRD SHOT").css({
            "top": "61%",
            "left": "52%"
        }).show();
    }).on('mouseleave', function() {
    ...
    $('#button5').on('mouseenter', function() {
        $("div.description").html("OSWALD").css({
            "top": "38%",
            "left": "13%"
        }).show();
    }).on('mouseleave', function() {
...
function funeral() {
    ...
    $("#closeIt").click(function() {
        ...
        if (closeItClick == 1) {
            $("#textH2").fadeOut(500).html(
                "You have arrived at St. Matthew's Cathedral").fadeIn(
                500);
        }
        if (closeItClick == 2) {
            $("#textH2").fadeOut(500).html(
                "This is where the state funeral of John Fitzgerald Kennedy takes place."
            ).fadeIn(500);
            //fadeIn foto
        }
        if (closeItClick == 3) {
            $("#textH2").fadeOut(500).html(
                "It is here where you hand Abraham Zapruder your report."
            ).fadeIn(500);
            //fadeIn foto
        }
        if (closeItClick == 4) {
            $("#textH2").fadeOut(500).html(
                "Good work and goodbye, detective. Untill we meet again."
            ).fadeIn(500);
